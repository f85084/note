...
;(function($){
    var Caroursel = function (caroursel){
        ...
        this.setting = {
            "width":"1000",  //旋轉的寬度
            "height":"270",  //旋轉的高度
            "posterWidth":"640", //圖片的寬度
            "posterHeight":"270", //圖片的高度
            "scale":"0.8",   //縮放值
			"algin":"middle",     //對齊方式
			"speed":"1000",       //動畫速度			
    ...
    Caroursel.prototype = {
        ...
        setFirstPosition:function(){
            ...
            //按鈕的樣式
            this.prevBtn.css({ "height":this.setting.height,"zIndex":Math.ceil(this.posterItems.size()/2)});
            this.nextBtn.css({ "height":this.setting.height,"zIndex":Math.ceil(this.posterItems.size()/2)});
